...
\title{\CT: An Approach to Recommend Relevant \GH Topics}%A Recommender 
...
software repositories. Topics have been introduced by GitHub as an effective 
manner to 
...
considered datasets, and pre-processing activities. Moreover, 
\TF can be combined with an existing topic recommender system (\ie MNB 
...
performances by employing the MNB network outcomes as initial topics
