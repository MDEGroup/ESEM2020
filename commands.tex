...
\newcommand{\rqfirst}{\textbf{RQ$_1$}: \emph{Which collaborative filtering configuration bings the best performance to \CT?}~}%\emph{How \CT parameter settings impact on the prediction performance?}~} 
%\newcommand{\rqsecond}{\textbf{RQ$_2$}: \emph{How the parameters have been evaluated?}~}
\newcommand{\rqsecond}{\textbf{RQ$_2$}: \emph{How \CT behave with respect the \MNB in terms of prediction performance?}~}
\newcommand{\rqthird}{\textbf{RQ$_3$}: \emph{Is the entangled approach able to improve \CT's overall performance?}~}
%\renewcommand{\hl}{}
