...
\newcommand{\rqfirst}{\textbf{RQ$_1$}: \emph{How the approach settings impact on the prediction performance?}~} 
\newcommand{\rqsecond}{\textbf{RQ$_2$}: \emph{How the parameters have been evaluated?}~}
\newcommand{\rqthird}{\textbf{RQ$_3$}: \emph{How \RECOMMENDER behave with respect the \MNB in terms of prediction performance?}~}
