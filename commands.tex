...
\newcommand{\rqfirst}{\textbf{RQ$_1$}: \emph{What is the best configuration of \RECOMMENDER}~} 
\newcommand{\rqsecond}{\textbf{RQ$_2$}: \emph{How well can \MNB and \RECOMMENDER recommend topics with respect to accuracy, sales diversity, and novelty?}~}
\newcommand{\rqthird}{\textbf{RQ$_3$}: \emph{What are the reasons for the performance difference between \MNB and \RECOMMENDER?}~}
\newcommand{\rqfourth}{\textbf{RQ$_4$}: \emph{Is the chain of approaches able to improve \RECOMMENDER's overall performance?}~}
%\renewcommand{\hl}{}
