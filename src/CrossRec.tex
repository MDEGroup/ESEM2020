...
similar ones to 
the given project. The \code{Recommendation Engine} \circled{3} 
...
libraries.~Finally, the recommendations \circled{6} are sent back to the developer. 
