...
include a sufficient number of repository for each topic. %\PN{@Claudio: For 
%this we need some references to explain why such the numbers are selected}. 
%\CDS{The query comes from empirical evaluation as stated above}
