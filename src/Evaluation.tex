...
\textit{cut-off} value~\cite{10.1145/3383219.3383227} \emph{t}, \ie the 
...
\textbf{D$_{20}$}, corresponding to the cut-off value \emph{t} = $\{1, 5, 10, 
15, 20\}$. \emph{Avg. topics} is the average number of topics that the 
repositories 
...
by the number of topics, which dramatically decrease to 1,989 when t=5. %The 
...
their number of stars and forks. A summary of the retrieved data is plotted it 
in 
...
set of assigned topics as input and for training. Thus, testing and training 
