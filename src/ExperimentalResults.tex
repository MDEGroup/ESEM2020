...
The bar charts in Fig.~\ref{fig:success-rateN5} and \ref{fig:success-rateN10} show the average success rates obtained by running the ten-fold cross-validation technique on \TF. %divided by the different topic frequency cut-off \emph{t}
