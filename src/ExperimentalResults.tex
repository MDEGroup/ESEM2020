...
This section analyzes the performance of \TF and compares it with \MNB by 
addressing the two research questions in Section~\ref{sec:EXP1} and 
Section~\ref{sec:EXP3}, respectively.
...
As presented in Section~\ref{sec:methodology-metric}, given a 
...
\begin{figure}[h!]
	...
	\caption{Precision/recall curves.}%Evaluation of the 
