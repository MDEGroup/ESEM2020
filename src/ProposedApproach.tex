...
\cite{10.1145/3383219.3383227}. % by combining it with \TFa. %\TF can be 
...
Given that $p$ has a set of neighbor nodes ($topic_{1}$, $topic_{2}$,.., 
...
%since there is a maximum of one $topic_{i}$ connected to $p$ by the 
...
Figure~\ref{fig:entangled} depicts an overview of the \TFb configuration: a 
