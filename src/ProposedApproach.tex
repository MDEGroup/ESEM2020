...
So far, we have described \TF as a stand-alone recommender system by describing its constituent components. To highlight its flexibility in a different context, we propose an approach to improve the existing \MNB. %as follows. %\emph{entangle} our tool with the MNB network using it as a black box. 
...
We assume that \TF can improve \MNB in the following term:
\begin{itemize}
