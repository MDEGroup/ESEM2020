...
In the following subsections, we describe two \TF configurations, namely \TFa and \TFb. The first one exploits a collaborative-filtering technique; and the second one  %in detail each of the components mentioned above. %In Section~\ref{sec:combined_approach}, 
